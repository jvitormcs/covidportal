...
<header>
    ...
    <img class="col-10 offset-1 img-fluid" src="images/bunnerbeta.png" alt="na esquerda tem um fundo branco, com virus azulados por cima, na direita tem um um fundo esverdeado indo para um azul e por cima está escrito Sintomas Covid-19 com a letra em branco">
<<<<<<< HEAD
    <div class="row text-center">
        <nav aria-label="breadcrumb">
        <ol class="breadcrumb bread">
                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                <li class="breadcrumb-item"><a href="sintomas.php">Sintomas</a></li>
                <li class="breadcrumb-item"><a href="varianteAlfa.php">Variante Alfa</a></li>
                <li class="breadcrumb-item active" aria-current="page">Variante Beta</li>
                <li class="breadcrumb-item"><a href="varianteGama.php">Variante Gama</a></li>
...
<main class="row offset-lg-1">
        ...
        <div class="container">
            <div class="col-lg-9">
                ...
                <section class=" col-lg-10 " >
                    <h3>Dados da variante</h3>
                    <p>A Variante Beta foi descoberta em Dezembro de 2020 na África do Sul.</p>
                    <p>Ela possui mutação em comum com a alfa, alem de que ela possui a capacidade de estimular uma conexão com as células humanas o que pode facilitar uma evasão dos anticorpos.</p>
                    <p>Uma das suas principais caracteristicas é que ela não possui uma maior capacidade de se multiplicar e transmitir, porem é a que se mostrou mais resistencia a vacinas, anticorpos e proteções do nosso corpo.</p>
                    <p>Ela conseguiu se transmitir para os Estados Unidos, Canadá e outros 58 países. O primeiro caso no Brasil foi descoberto em Abril, graças à rede de vigilância no interior paulista, coordenada pelo Instituto Butantan.</p>
                </section>
    ...
    <aside class=" offset-1 col-8 col-lg-3">
        ...
        <section>
            ...
            <p>Foi detectada em outubro de 2020 na Índia, foi rotulada como variante de preocupação em maio. Ela possui mais de uma dúzia de mutações, porem tem duas no centro da atenções. A alteração semelhante à notada na variante beta e gama, que pode facilitar o vírus a esquivar dos anticorpos. A potencial redução de neutralização pós-vacina.</p>
            <a href="varianteDelta.php">Saiba mais</a>
